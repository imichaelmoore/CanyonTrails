...
<div class="container">
  <% if (sessionBean.isAuthenticated() == true) { %>
    ...
    <div class="successBox"><%= sessionBean.successMessage %></div>
  ...
  <form action="update-account" method="post">
    ...
    <div class="form-section">
      <div class="form-group">
        ...
        <input type="text" name="name" class="form-control" id="name" value="<%= sessionBean.getAuthenticatedUserName() %>">
      </div>
      <div class="form-group">
        <label for="email">Email</label>
        <input type="email" name="email" class="form-control" id="email" value="<%= sessionBean.getAuthenticatedUserEmailAddress() %>">
      </div>
      <div class="form-group">
